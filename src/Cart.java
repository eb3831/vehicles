public class Cart extends Light
{
    ...
    public Cart( int carNumber, int age, int wheelsNumber, boolean shapeIsWheel, double emissionsPerMin,
                 boolean hasEngine, double chargingTime)
    {
    ...
    {
        return ( super.toString() + " ,chargingTime = " + this.chargingTime );
    }
}
