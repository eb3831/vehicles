public class Truck extends Heavy
{
    ...
    public Truck( int carNumber, int age, int wheelsNumber, boolean shapeIsWheel, double emissionsPerMin,
                  int trailersTheVehicleCanPull, double maxLoadWeight)
    {
    ...
    {
        return ( super.toString() + " ,maxLoadWeight = " + this.maxLoadWeight );
    }
}
