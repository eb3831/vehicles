public class Regular extends Vehicles
{
    ...
    public Regular( int carNumber, int age, int wheelsNumber, boolean shapeIsWheel, double emissionsPerMin,
    ...
    {
        return super.toString() + " ,howManyPassengers = " + this.howManyPassengers;
    }
}
