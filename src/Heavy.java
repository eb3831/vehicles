public class Heavy extends Vehicles
{
    ...
    public Heavy( int carNumber, int age, int wheelsNumber, boolean shapeIsWheel, double emissionsPerMin,
                  int trailersTheVehicleCanPull )
    {
    ...
    {
        return ( super.toString() + " ,trailersTheVehicleCanPull = " + this.trailersTheVehicleCanPull );
    }
}
