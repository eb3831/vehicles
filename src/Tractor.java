public class Tractor extends Heavy
{
    ...
    public Tractor( int carNumber, int age, int wheelsNumber, boolean shapeIsWheel, double emissionsPerMin,
                    int trailersTheVehicleCanPull, String typesOfTrailers )
    {
    ...
    public String ToString(){
        return ( "Tractor {" + " typesOfTrailers = " + this.typesOfTrailers + " } " );
