public class Bicycle extends Light
{
    ...
    public Bicycle( int carNumber, int age, int wheelsNumber, boolean shapeIsWheel, double emissionsPerMin,
                    boolean hasEngine, boolean hasBasket )
    {
    ...
    {
        return super.toString()+ " ,hasBasket = " + this.hasBasket;
    }
}
